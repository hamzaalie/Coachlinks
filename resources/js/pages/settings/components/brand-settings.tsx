...
export const DEFAULT_BRAND_SETTINGS: BrandSettings = {
  logoDark: '/images/logos/logo.png',
  logoLight: '/images/logos/logo-white.png',
...
export const getBrandSettings = (userSettings?: Record<string, string>): BrandSettings => {
  ...
  if (userSettings) {
    ...
    const normalizedLayoutDirection = userSettings.layoutDirection === 'rtl'
      ? 'right'
      : userSettings.layoutDirection === 'ltr'
        ? 'left'
    ...
    return {
      ...
      layoutDirection: normalizedLayoutDirection || DEFAULT_BRAND_SETTINGS.layoutDirection,
