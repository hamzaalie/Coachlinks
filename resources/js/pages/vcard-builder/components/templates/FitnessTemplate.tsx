    ...
    <div className="relative overflow-hidden">
      ...
      <div className="h-48 w-full relative">
        ...
        <div className="absolute bottom-4 left-4 right-4 text-white text-center">
          <div className="bg-black bg-opacity-50 p-2 rounded-lg inline-block">
            <p className="text-xs font-bold italic">{headerData.motivational_quote || 'TRANSFORM YOUR BODY, TRANSFORM YOUR LIFE'}</p>
          </div>
        </div>
      </div>
