...
export default function LifeCoachTemplate({ data, template }: LifeCoachTemplateProps) {
  ...
  const _fontPair = getCoachFonts('life-coach');
            ...
            {aboutData.specializations && (
              <div className="mb-4">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {(Array.isArray(aboutData.specializations) ? aboutData.specializations : String(aboutData.specializations || '').split(',').filter(Boolean)).map((spec: string, index: number) => (
  ...
  return (
    <>
    <style>{`
      .coach-tpl-lifecoach h1,
      .coach-tpl-lifecoach h2,
      .coach-tpl-lifecoach h3,
      .coach-tpl-lifecoach h4 { font-family: ${headingFont} !important; }
    `}</style>
    <div className="w-full max-w-md mx-auto rounded-3xl overflow-hidden coach-tpl-lifecoach" style={{ 
      fontFamily: font,
