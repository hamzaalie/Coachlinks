...
export const travelTemplate = {
  ...
  defaultData: {
    ...
    testimonials: {
      reviews: [
        { client_name: 'Jennifer & David', review: 'Our honeymoon to Bali was absolutely perfect. Wanderlust Travel took care of every detail, allowing us to focus on enjoying our special trip. The private villa they recommended was stunning!', destination: 'Bali', trip_date: 'September 2023' },
        { client_name: 'Robert T.', review: 'The guided tour of Japan was exceptional. Our guide was knowledgeable and took us to places we would never have discovered on our own. Will definitely book with Wanderlust again!', destination: 'Japan', trip_date: 'April 2023' },
        { client_name: 'The Martinez Family', review: 'Planning a trip for a family of five can be challenging, but Wanderlust made it easy. Our Costa Rica adventure had something for everyone - beaches, rainforests, and wildlife.', destination: 'Costa Rica', trip_date: 'July 2023' }
      ]
    },
    appointments: {
