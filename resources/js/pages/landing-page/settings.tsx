...
import { Save, Eye, Settings as SettingsIcon, Type, Info, Phone, Globe, Palette, Image, Users, Code, Search, Layout, Monitor, FileText, Award, HelpCircle, Trash2, Plus, X, GripVertical, ArrowUpDown } from 'lucide-react';
...
// Dynamic landing page config requires flexible types for section data
...
export default function LandingPageSettings() {
  ...
  const getSectionData = (key: string): SectionItem => {
    return (data.config_sections?.sections?.find(section => section.key === key) || { key: '' }) as SectionItem;
  };
  ...
  const saveSettings = () => {
    post(route('landing-page.settings.update'), {
      preserveScroll: true,
      onSuccess: () => {
        toast.success(t('Landing page settings saved successfully'));
      },
      onError: (validationErrors: Record<string, string>) => {
        const errorMessage = Object.values(validationErrors).join(', ') || t('Failed to save landing page settings');
  ...
  return (
    ...
    >
      <SettingsSection
        ...
        action={
          <Button onClick={saveSettings} disabled={processing} size="sm">
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setActiveSection(tab.sections[0] as typeof activeSection);
                  }}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('hero').stats || []).map((stat: any, index: number) => (
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const newStats = (getSectionData('hero').stats || []).filter((_: any, i: number) => i !== index);
                                updateSectionData('hero', { stats: newStats });
                              }}
                            >
            ...
            {activeSection === 'screenshots' && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("See CoachLinks in Action")}
                      />
                    </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('screenshots').screenshots_list || []).map((screenshot: any, index: number) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newScreenshots = (getSectionData('screenshots').screenshots_list || []).filter((_: any, i: number) => i !== index);
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-3">
                              ...
                              <Input
                                ...
                                placeholder={t("CoachLinks Dashboard Overview")}
                              />
                            </div>
                          </div>
            ...
            {activeSection === 'whychooseus' && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Why Choose CoachLinks?")}
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('why_choose_us').reasons || []).map((reason: any, index: number) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="font-semibold text-gray-900 flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newReasons = (getSectionData('why_choose_us').reasons || []).filter((_: any, i: number) => i !== index);
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('why_choose_us').stats || []).map((stat: any, index: number) => (
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button
                              ...
                              className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                              onClick={() => {
                                const newStats = (getSectionData('why_choose_us').stats || []).filter((_: any, i: number) => i !== index);
                                updateSectionData('why_choose_us', { stats: newStats });
                              }}
                            >
                              <Trash2 className="h-4 w-4" />
            ...
            {activeSection === 'team' && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('team').members || []).map((member: any, index: number) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="font-semibold text-gray-900 flex items-center gap-2">
                            <span className="w-6 h-6 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center text-xs font-bold">{index + 1}</span>
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newMembers = (getSectionData('team').members || []).filter((_: any, i: number) => i !== index);
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    {(getSectionData('testimonials').trust_stats || []).map((stat: any, index: number) => (
                      <div key={index} className="grid grid-cols-3 gap-4 p-4 border rounded-lg">
                        <div className="space-y-3">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button
                              ...
                              className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                              onClick={() => {
                                const newStats = (getSectionData('testimonials').trust_stats || []).filter((_: any, i: number) => i !== index);
                                updateSectionData('testimonials', { trust_stats: newStats });
                              }}
                            >
                              <Trash2 className="h-4 w-4" />
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('testimonials').testimonials || []).map((testimonial: any, index: number) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="font-semibold text-gray-900 flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newTestimonials = (getSectionData('testimonials').testimonials || []).filter((_: any, i: number) => i !== index);
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Get started with a paid plan and launch your profile fast...")}
                        rows={3}
                      />
                    </div>
            ...
            {activeSection === 'faq' && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('faq').faqs || []).map((faq: any, index: number) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="font-semibold text-gray-900 flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newFaqs = (getSectionData('faq').faqs || []).filter((_: any, i: number) => i !== index);
                        ...
                        <div className="space-y-4">
                          <div className="space-y-3">
                            ...
                            <Input
                              ...
                              placeholder={t("How does CoachLinks work?")}
                            />
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <Textarea
                              ...
                              placeholder={t("CoachLinks allows you to create professional coach profiles...")}
                              rows={3}
                            />
                          </div>
                        </div>
            ...
            {activeSection === 'newsletter' && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder={t("Stay Updated with CoachLinks")}
                      />
                    </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('newsletter').benefits || []).map((benefit: any, index: number) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="font-semibold text-gray-900 flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newBenefits = (getSectionData('newsletter').benefits || []).filter((_: any, i: number) => i !== index);
            ...
            {activeSection === 'contact' && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        placeholder={t("Have questions about CoachLinks?...")}
                        rows={3}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        value={data.contact_email || ''}
                        onChange={handleInputChange}
                        placeholder="support@coachlinks.net"
                        type="email"
                      />
                    </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('contact').faqs || []).map((faq: any, index: number) => (
                      <div key={index} className="p-4 border rounded-lg space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newFaqs = (getSectionData('contact').faqs || []).filter((_: any, i: number) => i !== index);
            ...
            {activeSection === 'footer' && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {(getSectionData('footer').social_links || []).map((social: any, index: number) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="font-semibold text-gray-900 flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                            onClick={() => {
                              const newSocials = (getSectionData('footer').social_links || []).filter((_: any, i: number) => i !== index);
            ...
            {activeSection === 'order' && (
              <div className="space-y-6">
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-3">
                    {(data.config_sections?.section_order || []).map((sectionKey: any, index: number) => {
