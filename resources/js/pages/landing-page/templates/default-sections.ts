export const defaultLandingPageSections = {
  sections: [
    ...
    {
      key: 'templates',
      title: 'Explore Our Coach Templates',
      subtitle: 'Choose from 30 professionally designed coaching templates. Pick your niche, customize it, and launch your page in minutes.',
      background_color: '#f8fafc',
      layout: 'carousel',
      columns: 3,
      templates_list: [
    ...
    },
    {
      ...
      story_content: 'Founded by a team of coaching enthusiasts and technology experts, CoachLinks was born from the need for a professional, coach-specific digital platform.',
      image: '',
    ...
    },
    {
      ...
      subtitle: 'Choose a plan and launch quickly. Upgrade anytime as you grow.',
