    ...
    public function run(): void
    {
        ...
        $templates = [
            ...
            [
                ...
                'translations' => [
                    'en' => [
                        'subject' => 'Payment Receipt - {order_number}',
                        'content' => '<p>Hello {user_name},</p><p>Thank you for your payment. Your receipt is below:</p><ul><li>Order: {order_number}</li><li>Plan: {plan_name}</li><li>Billing Cycle: {billing_cycle}</li><li>Amount Paid: {amount}</li><li>Discount: {discount_amount}</li><li>Payment Method: {payment_method}</li><li>Payment ID: {payment_id}</li><li>Paid At: {paid_at}</li></ul><p>You can manage your subscription anytime from your dashboard at {app_url}.</p><p>Regards,<br>{app_name}</p>'
                    ],
                ]
            ],
            [
                ...
                'translations' => [
                    'en' => [
                        'subject' => 'Your subscription is now active - {plan_name}',
                        'content' => '<p>Hello {user_name},</p><p>Your subscription has been activated successfully.</p><ul><li>Plan: {plan_name}</li><li>Billing Cycle: {billing_cycle}</li><li>Next Renewal Date: {next_renewal_date}</li></ul><p>Start using all your plan benefits now at {app_url}.</p><p>Regards,<br>{app_name}</p>'
                    ],
                ]
            ],
            [
                ...
                'translations' => [
                    'en' => [
                        'subject' => 'Subscription renewed successfully - {plan_name}',
                        'content' => '<p>Hello {user_name},</p><p>Your subscription renewal was successful.</p><ul><li>Plan: {plan_name}</li><li>Amount Charged: {amount}</li><li>Billing Cycle: {billing_cycle}</li><li>Next Renewal Date: {next_renewal_date}</li><li>Order: {order_number}</li></ul><p>Thank you for staying with {app_name}.</p>'
                    ],
                ]
            ],
            [
                ...
                'translations' => [
                    'en' => [
                        'subject' => 'Payment failed for your subscription - {plan_name}',
                        'content' => '<p>Hello {user_name},</p><p>We could not process your subscription payment.</p><ul><li>Plan: {plan_name}</li><li>Expected Amount: {amount}</li><li>Billing Cycle: {billing_cycle}</li><li>Order: {order_number}</li><li>Reason: {reason}</li></ul><p>Please update your payment method and try again from {app_url}.</p>'
                    ],
                ]
            ],
            [
                ...
                'translations' => [
                    'en' => [
                        ...
                        'content' => '<p>Hello {user_name},</p><p>Your subscription has been cancelled.</p><ul><li>Plan: {plan_name}</li><li>Effective Date: {cancelled_at}</li></ul><p>If this was not expected, please contact support.</p>'
                    ],
                ]
            ],
            [
                ...
                'translations' => [
                    'en' => [
                        'subject' => 'Your trial ends in {days_left} day(s)',
                        'content' => '<p>Hello {user_name},</p><p>Your trial will expire in <strong>{days_left}</strong> day(s).</p><ul><li>Trial End Date: {trial_end_date}</li></ul><p>Upgrade now to keep your account active: {app_url}</p>'
                    ],
                ]
            ],
            [
                ...
                'translations' => [
                    'en' => [
                        ...
                        'content' => '<p>Hello {user_name},</p><p>Your trial has expired on {trial_end_date}.</p><p>To continue using premium features, choose a subscription plan from {app_url}.</p>'
                    ],
                ]
            ]
        ];
