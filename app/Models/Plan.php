    ...
    public static function getDefaultFeatures()
    {
        return [
            ...
            'business_template_sections' => [
                'header', 'contact', 'about', 'programs', 'signature_offer', 'results',
                'transformations', 'lead_magnet', 'booking', 'videos', 'youtube', 'speaking',
                'social', 'links', 'business_hours', 'services', 'gallery', 'appointments',
                'testimonials', 'google_map', 'app_download', 'contact_form', 'thank_you',
                'seo', 'pixels', 'custom_html', 'qr_share', 'language', 'copyright', 'location'
            ]
        ];
    }
