...
class User extends BaseAuthenticatable implements MustVerifyEmail
{
    ...
    /**
     * Check if user is on free plan (no free plan exists — always false)
     */
    ...
    /**
     * Get current plan (no default plan fallback)
     */
    ...
    public function needsPlanSubscription()
    {
        ...
        // No plan at all — needs to subscribe
        if (!$this->plan_id) {
            return true;
        }
        
        // Check if trial is expired
        if ($this->is_trial && $this->isTrialExpired()) {
            return true;
        }
        
        // Check if plan is expired (paid subscription)
    ...
    protected static function boot()
    {
        ...
        static::created(function ($user) {
            // Trial plan is assigned during registration in RegisteredUserController.
            // No default free plan assignment needed.
        });
    }
}