...
class LandingPageController extends Controller
{
    public function show(Request $request)
    {
        ...
        $plans = Plan::where('is_plan_enable', 'on')->get()->map(function ($plan) {
            ...
            // Align landing features with in-app plan feature matrix.
            if ($plan->features) {
                ...
                $features[] = !empty($templateSections)
                    ? __('Template Sections ( :count )', ['count' => count($templateSections)])
                    : __('Template Sections ( :count )', ['count' => 0]);
            } else {
            ...
            return [
                ...
                'stats' => [
                    ...
                    'templates' => is_array($plan->themes) ? count($plan->themes) : 60,
