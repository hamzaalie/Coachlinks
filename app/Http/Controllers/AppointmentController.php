...
[
        ...
        $googleCalendar = new GoogleCalendarService($this->getBusinessOwnerId($business));
...
[
        ...
        if ($appointment->google_event_id) {
            $googleCalendar = new GoogleCalendarService($this->getBusinessOwnerId($targetBusiness));
    ...
    private function getBusinessOwnerId(Business $business): ?int
    {
        ...
        if (!$owner) {
            return (int) $business->created_by;
        }

        if (in_array($owner->type, ['superadmin', 'company'], true)) {
            return $owner->id;
        }
