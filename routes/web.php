...
Route::middleware(['auth', 'verified','setting'])->group(function () {
    // Onboarding routes - accessible without plan check
    Route::get('onboarding/template-selection', [OnboardingController::class, 'templateSelection'])
        ->name('onboarding.template-selection');
    Route::post('onboarding/template-selection', [OnboardingController::class, 'saveTemplateSelection'])
        ->name('onboarding.template-selection.store');
    ...
    Route::delete('media/{id}', [MediaController::class, 'destroy'])->middleware('permission:delete-media')->name('media.destroy');
        ...
        Route::get('vcard-builder/templates', [VCardBuilderController::class, 'templates'])->middleware('permission:create-vcard-builder')->name('vcard-builder.templates');
